...
train_model(model_res, train_loader, val_loader, criterion, optimizer, num_epochs=15)
...
test_model(model_res, test_loader)
...
with open("resnet_labels_data.pkl", "wb") as f:
